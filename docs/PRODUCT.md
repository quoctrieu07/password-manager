...
| P2-04 | Kéo thả sắp xếp | Tối ưu hóa trải nghiệm điều hướng danh mục | \- Dùng chuột kéo thả tài khoản vào các nhóm ở Sidebar.\- Bảng Settings cho phép chỉnh thời gian tự khóa linh hoạt. | Có thể có |
...
| P3-02 | Bảo mật đường truyền | Mã hóa gói tin và xác thực an toàn | \- Băm mật khẩu trước khi gửi lên mạng.\- Áp dụng mã hóa phiên và token JWT để chặn đánh chặn dữ liệu. | Nên có |
