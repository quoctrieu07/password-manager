...
| P2-02 | Tự động khóa | Tự khóa màn hình khi người dùng rời máy | \- Sau 5 phút không hoạt động chuột/phím, RAM tự xóa dữ liệu.\- Hiển thị màn hình khóa yêu cầu nhập lại mật khẩu. | Nên có |
