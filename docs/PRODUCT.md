...
| P2-01 | Mã hóa file AES | Bảo vệ file JSON bằng Master Password | \- File tải về được mã hóa thành chuỗi ký tự vô nghĩa.&lt;br&gt;- Yêu cầu nhập đúng Master Password để giải mã. | Nên có |
...
| P2-03 | Theme Material You | Nâng cấp thẩm mỹ giao diện động hiện đại | \- Chuyển đổi mượt mà chế độ Sáng/Tối.&lt;br&gt;- Màu sắc giao diện thay đổi đồng bộ theo hệ thống. | Có thể có |
| P2-04 | Kéo thả sắp xếp | Tối ưu hóa trải nghiệm điều hướng danh mục | \- Dùng chuột kéo thả tài khoản vào các nhóm ở Sidebar.&lt;br&gt;- Bảng Settings cho phép chỉnh thời gian tự khóa linh hoạt. | Có thể có |
...
| P3-02 | Bảo mật đường truyền | [DA phụ trách] Mã hóa gói tin và xác thực an toàn | \- Băm mật khẩu bằng PBKDF2/Argon2 trước khi gửi lên mạng.<br>\- Áp dụng mã hóa phiên và token JWT để chặn đánh chặn dữ liệu. | Bắt buộc |
...
| P3-04 | Gọt giũa cấu trúc GUI | Loại bỏ cấu phần thừa và tối ưu hóa điều hướng | \- Loại bỏ tính năng double-click cũ, thay bằng nút bấm tường minh.<br>\- Chuyển đổi bộ đếm TOTP tròn sang thanh tiến trình dạng đường thẳng. | Nên có |
