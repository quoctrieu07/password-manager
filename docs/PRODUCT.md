...
| P3-02 | Bảo mật đường truyền | Mã hóa gói tin và xác thực an toàn | \- Băm mật khẩu trước khi gửi lên mạng.\- Áp dụng mã hóa phiên và token JWT để chặn đánh chặn dữ liệu. | Có thể có |
